      ...
      <div className='row'>
        <div className='col-sm-12 projectCards'>
          ...
          <ul className='highlights'>
            ...
            <li className='bullet'>
              Willing to master the <y>full-stack</y> part of programming, I maintain a playground linux server, where I test different technologies, like: <y>NGINX, NodeJS</y>; and learn about API's and databases in a live system.
              <br />
              <small>🔗 </small>{' '}
