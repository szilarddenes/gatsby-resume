      ...
      <div className='row'>
          ...
          <div className='col-sm-12 projectCards'>
            ...
            <ul className='highlights'>
                 <li className='bullet'>
                 4 years of HTML, CSS and Javascript knowledge: I have learnt the basics in 3 months and created my first website using these languages. (link to munkaportal)
