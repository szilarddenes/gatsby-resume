      ...
      <div className='row'>
        <div className='col-sm-12 projectCards'>
          ...
          <ul className='highlights'>
            ...
            <li className='bullet'>
              Willing to master the <y>FullStack</y> world, I maintain a playground linux server, where I test different technologies, like: <y>NGINX, NodeJS</y>; and learn about API's, databases in liv.
              <br />
              <small>🔗 </small>{' '}
              <a href='https://www.jointadventure.co' target='_blank'>
                jointadventure.co
