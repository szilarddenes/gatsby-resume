      ...
      <div className='row'>
          ...
          <div className='col-sm-12 projectCards'>
            ...
            <ul className='highlights'>
                 ...
                 <li className='bullet'>
                 1.5 years in the world of React and GatsbyJS. I created 3 websites using this technology.  <br />
                 <small>🔗 </small> <a href="https://www.jointadventure.co/work/munkaportal.ro/" 
                 target="_blank">munkaportal.ro</a> 
                 </li>
             </ul>
