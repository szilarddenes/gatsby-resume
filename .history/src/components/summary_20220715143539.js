      ...
      <div className='row'>
          ...
          <div className='col-sm-12 projectCards'>
            ...
            <ul className='highlights'>
                 ...
                 🔗 <a href="https://www.jointadventure.co/work/munkaportal.ro/" target="_blank">munkaportal.ro</a> 
                 </li>
                 <li className='bullet'>
                 2 years in WordPress: made several offline projects, and in 10-12 months I coded up the 🔗 <a href="https://www.jointadventure.co/work/munkaportal.ro/" target="_blank">jobp.eu</a> . For learning purposes I created a WordPress plugin. I also had a converting webshop, where I made minor/major modifications in the theme.
                 </li>
             </ul>
