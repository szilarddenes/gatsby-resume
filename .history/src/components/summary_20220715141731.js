    ...
    <div className='col-sm-9'>
      <div className='row'>
          ...
          <div className='col-sm-12 projectCards'>
            ...
            <small>Note: self-taught learning, focus on delivering the projects for clients, or for myself –  The years of experience highlighted below for a language is asynchronous, I’ve learnt for the given project what I needed, next to my 9-5 regular job. 
            </small>
