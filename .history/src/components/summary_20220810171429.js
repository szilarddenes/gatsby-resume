        ...
        <div className='col-sm-12 projectCards'>
          ...
          <div className='website pull-right'>
            <li className='paddingLeft'>
              To grow in a professional environment and became a Fullstack Software Engineer in
              a couple of years.
            </li>
          </div>
          ...
          <ul className='highlights'>
            ...
            <li className='bullet'>
              Willing to master the <y>full-stack</y> world of programming, I maintain a playground linux server, where I test different technologies, like: <y>NGINX, NodeJS</y>; and learn about API's, databases in a live system.
              <br />
              <small>🔗 </small>{' '}
