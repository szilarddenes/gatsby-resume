        ...
        <div className='col-sm-12 projectCards'>
          ...
          <div className='website pull-right'>
            <li className='paddingLeft'>
              To get my first job in the world of programming to grow in a
              professional environment.
            </li>
            <li className='paddingLeft'>
              To grow in professional environment and became a Fullstack Software Engineer and build SaaS products in
              a couple of years.
            </li>
          </div>
          <h4 className='colorGreen'> Experience </h4>
          <small>
            Note: self-taught learning, focus on delivering the projects for
            clients, or for myself – The years of experience highlighted below
