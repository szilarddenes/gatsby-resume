      ...
      <div className='row'>
          ...
          <div className='col-sm-12 projectCards'>
            ...
            <div className='website pull-right'>
                <li className="">Get my first job in the world of programming to grow in a professional environment</li>
                <li>became a Fullstack Software Engineer and build SaaS products in a couple of years
</li>
            </div>
